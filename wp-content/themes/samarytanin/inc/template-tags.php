...
if ( ! function_exists( 'samarytanin_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function samarytanin_posted_on() {
...
if ( ! function_exists( 'samarytanin_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function samarytanin_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'samarytanin_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function samarytanin_entry_footer() {
...
if ( ! function_exists( 'samarytanin_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function samarytanin_post_thumbnail() {
