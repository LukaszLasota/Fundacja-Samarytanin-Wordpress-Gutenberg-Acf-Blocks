 ...
 */
function samarytanin_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'samarytanin_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
 ...
 * @return void
 */
function samarytanin_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function samarytanin_customize_partial_blogdescription() {
