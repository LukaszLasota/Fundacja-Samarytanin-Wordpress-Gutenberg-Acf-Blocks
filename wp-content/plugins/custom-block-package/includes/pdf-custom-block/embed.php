...
function pdfjs_generator( $incoming_from_handler ) {
	$viewer_base_url   = plugin_dir_url( __DIR__ ) . 'pdf-custom-block/pdfjs/web/viewer.php';
	...
	$final_url = $viewer_base_url . $attachment_info . '&pButton=' . '&sButton=' . $searchbutton . '&pagemode=' . $pagemode . '&_wpnonce=' . $nonce;
